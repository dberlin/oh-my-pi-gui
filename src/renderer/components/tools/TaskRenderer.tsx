...
const PRIORITY_ORD: Record<string, number> = { P0: 0, P1: 1, P2: 2, P3: 3 };
...
function orderProgressForDisplay(list: Record<string, unknown>[]): Record<string, unknown>[] {
...
function yieldLabels(type: RenderYieldItem["type"]): string[] {
...
function normalizeFindingPriority(value: unknown): string | undefined {
 ...
 */
function extractReviewResult(items: RenderYieldItem[]): ReviewResult | undefined {
