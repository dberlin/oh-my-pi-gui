...
Current release: [**v0.8.2**](https://github.com/nornzach/oh-my-pi-gui/releases/tag/v0.8.2)

- **Apple Silicon (M1/M2/M3/M4):** `omp-0.8.2-arm64.dmg`
- **Intel:** `omp-0.8.2.dmg`
...
当前版本：[**v0.8.2**](https://github.com/nornzach/oh-my-pi-gui/releases/tag/v0.8.2)
