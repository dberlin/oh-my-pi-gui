...
Current release: [**v0.4.0**](https://github.com/nornzach/oh-my-pi-gui/releases/tag/v0.4.0)

- **Apple Silicon (M1/M2/M3/M4):** `omp-0.4.0-arm64.dmg`
- **Intel:** `omp-0.4.0.dmg`
...
当前版本：[**v0.4.0**](https://github.com/nornzach/oh-my-pi-gui/releases/tag/v0.4.0)
